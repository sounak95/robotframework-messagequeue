...
class MessageQueue(object):
    ...
    def mx_connect_to_message_queue(self,queue_type,host,port,user_name=None,password=None,queue_manager=None,channel=None):
    ...
    def mx_put_message_to_queue(self, session, queue_type, queue_name,inputfilepath, headers=None):
        """|Usage|  To put message to the queue.
                 ...
                 'inputfilepath' = file path of the message
                  Example:
                      ${session}    Mx Connect To Message Queue    IBM    ${host}    ${port}   queue_manager=${queue_manager}    channel=${channel}
                        Mx Put Message To Queue    ${session}    IBM    ${queue_name}    ${inputfilepath}
        """
        if inputfilepath:
    ...
    def mx_get_message_from_queue(self, queue_type, queue_name, session, uniquemessageid=None, outputfilepath=None):
    ...
    def mx_clear_queue(self, session, queue_type, queue_name):
        """|Usage|  To clear all messages from IBM or Active MQ
                 ...
                 'queue_name' = Name of IBM MQ or Active MQ queue
                  Example:
                      Mx Clear Queue    ${var}    Active    sample.q
                  """
        if queue_type.upper() == "IBM":
    ...
    def mx_disconnect_message_queue(self, session):
